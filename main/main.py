...
bg_img = pygame.image.load('main/assets/sprites/space.png')
ship_img = pygame.image.load('main/assets/sprites/spaceship.png')
medium_asteroid_img = pygame.image.load('main/assets/sprites/asteroid.png')
...
bullet_img = pygame.image.load('main/assets/sprites/bullet.png')

shoot_sound = pygame.mixer.Sound('main/assets/sounds/laser.mp3')
explosion_sound = pygame.mixer.Sound('main/assets/sounds/explosion.mp3')
