...
class AssetManager:
    ...
    def __init__(self):
        ...
        if not hasattr(self, "initialised"):
            ...
            self._big_asteroid_img = pygame.transform.scale(self.medium_asteroid_img, (150, 150))
            self._small_asteroid_img = pygame.transform.scale(self.medium_asteroid_img, (50, 50))
